...
Шаг `attachAvatar` повторяет временную недоступность Files: всего 5 попыток с паузами
1, 2, 4 и 8 секунд. Бизнес-ошибки и неизвестные ошибки не повторяются.
...
повтор с тем же ключом воспроизводит эту ошибку. Сумма пауз — 15 секунд, но это не ограничение
