...
const GRPC_STATUS_BY_APP_ERROR_CODE = {
  ...
  [FilesErrorCode.IMAGE_UPLOAD_OPERATION_CONFLICT]: status.ALREADY_EXISTS,
  [FilesErrorCode.INVALID_IMAGE_UPLOAD_ID]: status.INVALID_ARGUMENT,
  [FilesErrorCode.INVALID_IMAGE_UPLOAD_STATUS]: status.FAILED_PRECONDITION,
  [FilesErrorCode.INVALID_IMAGE_UPLOAD_OPERATION_ID]: status.INVALID_ARGUMENT,
  [FilesErrorCode.INVALID_IMAGE_UPLOAD_RESERVATION_ID]: status.INVALID_ARGUMENT,
