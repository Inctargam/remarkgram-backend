...
export type PostImageWhereInput = {
  ...
  fileId?: Prisma.UuidFilter<"PostImage"> | string
...
export type PostImageScalarWhereWithAggregatesInput = {
  ...
  fileId?: Prisma.UuidWithAggregatesFilter<"PostImage"> | string
...
export type PostImageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"fileId" | "postId" | "position", ExtArgs["result"]["postImage"]>
...
export interface PostImageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const postImageWithFileIdOnly = await prisma.postImage.findMany({ select: { fileId: true } })
   *
   */
   ...
   * })
   *
   * // Create many PostImages and only return the `fileId`
   * const postImageWithFileIdOnly = await prisma.postImage.createManyAndReturn({
   *   select: { fileId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   *
   * // Update zero or more PostImages and only return the `fileId`
   * const postImageWithFileIdOnly = await prisma.postImage.updateManyAndReturn({
   *   select: { fileId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PostImageFieldRefs {
  readonly fileId: Prisma.FieldRef<"PostImage", 'String'>
