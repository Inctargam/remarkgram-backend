...
class UserAccountsMessageBrokerConfig {
  @IsUrl(
    {
...
export const userAccountsMessageBrokerConfig = registerAs('userAccountsMessageBroker', () => {
  const config = plainToInstance(UserAccountsMessageBrokerConfig, {
